...
import everythingStuff.CopyOfGrabEverythingVisitor.ClassVisitor;
import everythingStuff.CopyOfGrabEverythingVisitor.MethodVisitor;
...
public class CopyOfJEverythingRecordReader extends RecordReader<GeneralID, Text> {
	...
	protected List<GeneralID> keys;
	protected int curr = -1;
	protected ClassVisitor cVisitor;
	protected MethodVisitor mVisitor;
	protected CopyOfGrabEverythingVisitor visitor;

	public Map<GeneralID, Text> getMethods() {
		return elems;
	}
	...
	protected List<GeneralID> getmKeys() {
		return keys;
	}
	...
	public List<GeneralID> getKeys() {
		return keys;
	}

	public void setKeys(List<GeneralID> keys) {
		this.keys = keys;
	}
	
	public CopyOfJEverythingRecordReader( ){
		visitor = new CopyOfGrabEverythingVisitor();
	...
	public void initialize(InputSplit inSplit, TaskAttemptContext tac) throws IOException,
		...
		if (elems.keySet().size() > 0)
			keys = new ArrayList<GeneralID>(elems.keySet());
		
	//	for (GeneralID gid : elems.keySet())
	//TODO kill this		System.out.println(gid.toString());
	}
	 ...
	 */
	@Override
	public GeneralID getCurrentKey() throws IOException, InterruptedException {
