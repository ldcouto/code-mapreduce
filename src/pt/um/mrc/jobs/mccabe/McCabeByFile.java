...
public class McCabeByFile
{
    public static void main(String[] args) throws Exception
    {
        ...
        JobConfigurer jc = new JobConfigurer(McCabeByFile.class, TextInputFormat.class, new Path(
                otherArgs[0]), new Path(otherArgs[1]));

        MapperConfigurer mc = new MapperConfigurer(McCabeByFileMapper.class, Text.class,
                IntWritable.class);
