...
public class CachedInfoMapperTest {
	...
	public final void testSetup() throws IOException, InterruptedException {
		...
		MockMapContextWrapper<Text, Text, Text, Text> mockContext =
			new MockMapContextWrapper<Text, Text, Text, Text>();
	...
	public void testBuildCache() throws IOException {
		...
		expected.put("pt.um.mrc.util.reducers", new ArrayList<String>(Arrays.asList(
			"pt.um.mrc.util.reducers.CollectionReducer", "pt.um.mrc.util.reducers.IdentityReducer", "pt.um.mrc.util.reducers.ReduceHelpers", "pt.um.mrc.util.reducers.SumReducer")));
		expected.put("pt.um.mrc.util.mappers", new ArrayList<String>(Arrays.asList(
			"pt.um.mrc.util.mappers.CachedPackageInfoMapper", "pt.um.mrc.util.mappers.LineValuesMapper")));
