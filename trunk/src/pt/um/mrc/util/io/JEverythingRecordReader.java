...
import pt.um.mrc.util.io.GrabEverythingVisitor.ClassVisitor;
import pt.um.mrc.util.io.GrabEverythingVisitor.MethodVisitor;
...
public class JEverythingRecordReader extends RecordReader<GeneralID, Text> {
